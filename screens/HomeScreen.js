...
const HomeScreen = () => {
  ...
  const [locationServicesEnabled, setlocationServiceEnabled] = useState(false);
  useEffect(() => {
    ...
    <>
        ...
        >
          ...
          <Pressable onPress={()=>navigation.navigate("Profile")} style={{ marginLeft: "auto", marginRight: 7 }}>
            <Image
              ...
              source={{
                uri: "https://media.geeksforgeeks.org/auth/profile/5pdafh7wsqbzv169fyga",
              }}
            />
          </Pressable>
        </View>
      ...
      >
        <View>
          ...
          <Text style={{fontSize:12,fontWeight:"400",color:"white",marginVertical:6}}>Extra charges may apply</Text>
        </View>
